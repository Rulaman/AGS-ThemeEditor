...
{
	public partial class StringControl : UserControl, System.ComponentModel.INotifyPropertyChanged
	{
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			if ( e.ClipRectangle != Rectangle.Empty )
			{
				...
				e.Graphics.DrawString(Value, DescFont, DescBrush, ValuePosition);
			}
		}
